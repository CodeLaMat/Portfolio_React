      ...
      <div className={classes.contact_container}>
        <div className={classes.media_container}>
          ...
          <div className={classes.media_icons}>
            <div className={classes.media_github}>
              <a
                href="https://github.com/CodeLaMat"
            ...
            <div className={classes.media_facebook}>
              <a
            ...
            <div className={classes.media_whatsapp}>
              <a
                href="https://wa.me/00358403705049"
            ...
            <div className={classes.media_discord}>
              <a
